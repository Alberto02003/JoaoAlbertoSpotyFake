...
import com.example.joaoalbertospotyfake.objetos.EstadoExoPlayer
import com.example.joaoalbertospotyfake.shared.ExoPlayerViewModel
...
fun SliderReproductor(
    ...
    Slider(value = value,
        colors = SliderDefaults.colors(Grey, Verde),
...
fun BotonesReproductor(exoPlayerViewModel: ExoPlayerViewModel, contexto: Context) {
    ...
    Boton(iconId = R.drawable.baseline_shuffle_24, contentColor = shufleColor, onClick = {
        ...
        shufleColor = if (shufleColor == Grey) {
            Grey
        } else {
            Grey
        }
    ...
    Boton(iconId = R.drawable.baseline_loop_24, contentColor = loopButtonColor, onClick = {
        ...
        loopButtonColor = if (loopButtonColor == Grey) {
            Grey
        } else {
            Grey
        }
